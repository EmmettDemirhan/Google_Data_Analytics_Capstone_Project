...
```{r Unique id,  results='hide', echo=FALSE, message=FALSE, warning=FALSE}
# Checking Unique IDs
...
```
```{r removing duplicates,  results='hide', echo=FALSE, message=FALSE, warning=FALSE}
